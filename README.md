...
## in the cart menu if there is no internet connection or no database connection, still show the menu , just make the cart and order modular such that they wont cause any kind of problem.
